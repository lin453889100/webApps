    ...
    <div class="top-nav-constance displayHide">
        <div class="top-nav normal-width"><a class="top-nav-logo" href="index.html"></a>
            ...
            <div class="top-nav-ul" data-focus-li="alwaysWhite"><a data-focus="index" href="index.html">首页</a>
                ...
                <!--<a>解决方案</a>-->
                <!--<a>成功案例</a>-->
                <!--<a>支持</a>--><a class="top-login" href="https://ones.ai/project/#/home"><span>Login</span></a>
                <div class="top-registered"><span class="index-pc">Login</span></div>
            </div>
            <!--<div class="top-button index-mobile">-->
            <!--登录-->
            <!--</div>-->
        </div>
    </div><a href="sign_up.html" class="mobile-top-registered displayHide">Login</a>
    ...
    <div class="sign-up sign-up-small-center">
        ...
        <div class="sign-up-content">
            <div class="sign-up-title">
                ...
                <div class="sign-up-step-1 sign-up-step-in_progress sign-up-step">Wecome!</div>
                <div class="sign-up-step-1 sign-up-step-in_progress sign-up-step" style=" left: 255px; color: #4c98f1;"><a href="${root }/signUp">Sign up</a></div>
            </div>
            <div class="sign-up-main">
                <div class="sign-up-step-main">
                    <div class="sign-up-step-1 sign-up-step-in_progress sign-up-step">
                        ...
                        <div class="normal-button" onclick="login();">login</div>
                        <div class="index-pc">
                            <div id="entrar-al-sistema" class="normal-button-admin normal-button" onclick="toUpload();">Upload</div>
                        </div>
                    </div>
                </div>
            </div>
	    ...
	    $.ajax({
	        ...
	        success:function(data) {
	            if(data.msg == '1'){
	            	...
	            	window.location.href = '${root}/login/toList';
	            } else {
	            	alert(data.msg);
	            }
	        }
...
function toUpload(){
	...
	if(loginId == null || loginId == ''){
		...
		window.location.href = '${root}/toUpload';
	}
}
/* fnlogin({
    username:'',
